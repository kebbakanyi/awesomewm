...
theme.fg_normal                                 = "#FF7034" --rusty orange
theme.fg_focus                                  = "#13F7ED"
...
theme.border_focus                              = "#13F7ED"
theme.taglist_fg_focus                          = "#13F7ED" -- cyan looking
theme.tasklist_bg_normal                        = "#222222"
theme.tasklist_fg_focus                         = "#13F7ED"
...
-- Calendar
local mytextcalendar = wibox.widget.textclock(markup.fontfg(theme.font, "#FF7034", space3 .. "%d %b " .. markup.font("Roboto 5", " ")))
...
local memory = lain.widget.mem({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#FF7034", mem_now.used .. "M "))
    end
...
function theme.at_screen_connect(s)
    ...
    --s.mybottomwibox = awful.wibar({ position = "bottom", screen = s, border_width = dpi(0), height = dpi(28) })
    --s.borderwibox = awful.wibar({ position = "bottom", screen = s, height = dpi(1), bg = theme.fg_focus, x = dpi(0), y = dpi(29)})
